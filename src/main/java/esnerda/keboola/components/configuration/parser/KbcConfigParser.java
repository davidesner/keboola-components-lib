...
/**
 *
 * author David Esner <code>&lt;esnerda at gmail.com&gt;</code> created 2015
 */
public class KbcConfigParser implements ConfigParser {
	...
	public KBCConfig parseConfigFile(File file, Class paramsType) throws IOException {
		...
		mapper.registerModule(module); // important, otherwise won't have any
										// effect on mapper's configuration
